...
import { Calendar, User, MessageSquare, FileText, BarChart3, CreditCard, BadgeEuro } from "lucide-react"
...
import { getConversationByUser, Conversation } from "@/actions/conversations" // Importer les conversations
...
export default function ProfileLayout() {
  ...
  const displayData = chartData.length > 0 ? chartData : [{ month: "Aucune donnée", messages: 0, documents: 0, reports: 0, credits: 0, conversations: 0 }];
              ...
              <TabsContent value="summary">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm font-medium flex items-center gap-2">
                        <BadgeEuro className="h-4 w-4" /> Crédits utilisés
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-2xl font-bold">{displayData[0]?.credits || 0}</p>
                    </CardContent>
                  </Card>
                </div>
              </TabsContent>
